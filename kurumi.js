!function (t) {
    ...
    function n(t) {
        ...
        var r = e / i, o = x.default.VIEW_LOGICAL_LEFT, n = x.default.VIEW_LOGICAL_RIGHT, _ = -r, h = r;
    ...
    (function (t) {
        !function () {
            ...
            i._$0s = 1, i._$4s = 2, i._$42 = 0, i._$62 = function (t, e) {
                ...
                var i = _._$fT[t];
                if (null != i) {
                    var e = x.getSystemTimeMSec(), r = e - i._$0S;
            ...
            It._$ni = function (t, i, e, r, o, n, s, _, a) {
                ...
                if (4 == o) {
                    var S = r[n[0]], v = r[n[1]], L = r[n[2]], M = r[n[3]], E = r[n[4]], A = r[n[5]], I = r[n[6]],
                        x = r[n[7]], w = r[n[8]], O = r[n[9]], D = r[n[10]], R = r[n[11]], b = r[n[12]], F = r[n[13]],
            ...
            xt.STATE_FIRST = "STATE_FIRST", xt.STATE_INTERVAL = "STATE_INTERVAL", xt.STATE_CLOSING = "STATE_CLOSING", xt.STATE_CLOSED = "STATE_CLOSED", xt.STATE_OPENING = "STATE_OPENING", X.prototype = new E, X._$As = 32, X._$Gr = !1, X._$NT = null, X._$vS = null, X._$no = null, X._$9r = function (t) {
                ...
                if (this._$GS._$Ur(t)) {
                    ...
                    if (this._$GS._$zr(n, s, o), o <= 0) {
                        ...
                        var E = this._$Y0[n[0]], A = this._$Y0[n[1]], I = this._$Y0[n[2]], x = this._$Y0[n[3]],
                            w = this._$Y0[n[4]], O = this._$Y0[n[5]], D = this._$Y0[n[6]], R = this._$Y0[n[7]],
                            ...
                            f = I._$fL + (x._$fL - I._$fL) * h, L = w._$fL + (O._$fL - w._$fL) * h,
                ...
                for (var h, l, $, u = r * n, p = 0, f = 0, c = 0, d = 0, g = 0, y = 0, m = !1, T = o; T < u; T += n) {
                    ...
                    if (v = i[T], L = i[T + 1], P = v * _, S = L * a, P < 0 || S < 0 || _ <= P || a <= S) {
                        ...
                        if (-2 < v && v < 3 && -2 < L && L < 3) if (v <= 0) if (L <= 0) {
                            var w = s[2 * (0 + 0 * M)], O = s[2 * (0 + 0 * M) + 1], D = p - 2 * c, R = f - 2 * d,
                            ...
                            var b = s[2 * (0 + a * M)], F = s[2 * (0 + a * M) + 1], C = p - 2 * c + 1 * g,
                                N = f - 2 * d + 1 * y, w = p + 3 * g, O = f + 3 * y, D = p - 2 * c + 3 * g,
                            ...
                            var B = .5 * (v - -2), U = S - G, Y = G / a, k = (G + 1) / a, b = s[2 * (0 + G * M)],
                                F = s[2 * (0 + G * M) + 1], w = s[2 * (0 + (G + 1) * M)],
                                O = s[2 * (0 + (G + 1) * M) + 1], C = p - 2 * c + Y * g, N = f - 2 * d + Y * y,
                                D = p - 2 * c + k * g, R = f - 2 * d + k * y;
                            B + U <= 1 ? (e[T] = C + (b - C) * B + (D - C) * U, e[T + 1] = N + (F - N) * B + (R - N) * U) : (e[T] = w + (D - w) * (1 - B) + (b - w) * (1 - U), e[T + 1] = O + (R - O) * (1 - B) + (F - O) * (1 - U))
                        } else if (1 <= v) if (L <= 0) {
                            var D = s[2 * (_ + 0 * M)], R = s[2 * (_ + 0 * M) + 1], w = p + 3 * c, O = f + 3 * d,
                            ...
                            var C = s[2 * (_ + a * M)], N = s[2 * (_ + a * M) + 1], b = p + 3 * c + 1 * g,
                                ...
                                w = p + 3 * c + 3 * g, O = f + 3 * d + 3 * y, B = .5 * (v - 1), U = .5 * (L - 1);
                            B + U <= 1 ? (e[T] = C + (b - C) * B + (D - C) * U, e[T + 1] = N + (F - N) * B + (R - N) * U) : (e[T] = w + (D - w) * (1 - B) + (b - w) * (1 - U), e[T + 1] = O + (R - O) * (1 - B) + (F - O) * (1 - U))
                        } else {
                            var G = 0 | S;
                            G == a && (G = a - 1);
                            var B = .5 * (v - 1), U = S - G, Y = G / a, k = (G + 1) / a, C = s[2 * (_ + G * M)],
                                ...
                                w = p + 3 * c + k * g, O = f + 3 * d + k * y;
                            B + U <= 1 ? (e[T] = C + (b - C) * B + (D - C) * U, e[T + 1] = N + (F - N) * B + (R - N) * U) : (e[T] = w + (D - w) * (1 - B) + (b - w) * (1 - U), e[T + 1] = O + (R - O) * (1 - B) + (F - O) * (1 - U))
                        } else if (L <= 0) {
                            var V = 0 | P;
                            V == _ && (V = _ - 1);
                            var B = P - V, U = .5 * (L - -2), X = V / _, z = (V + 1) / _, D = s[2 * (V + 0 * M)],
                                R = s[2 * (V + 0 * M) + 1], w = s[2 * (V + 1 + 0 * M)], O = s[2 * (V + 1 + 0 * M) + 1],
                            ...
                            var B = P - V, U = .5 * (L - 1), X = V / _, z = (V + 1) / _, C = s[2 * (V + a * M)],
                                ...
                                D = p + X * c + 3 * g, R = f + X * d + 3 * y, w = p + z * c + 3 * g,
                                O = f + z * d + 3 * y;
                            B + U <= 1 ? (e[T] = C + (b - C) * B + (D - C) * U, e[T + 1] = N + (F - N) * B + (R - N) * U) : (e[T] = w + (D - w) * (1 - B) + (b - w) * (1 - U), e[T + 1] = O + (R - O) * (1 - B) + (F - O) * (1 - U))
                ...
                try {
                    ...
                    for (var h = i.length, l = t.width, $ = t.height, u = this.context, p = this._$xP, f = this._$uP, c = this._$6r, d = this._$3r, g = nt.tr, y = nt._$Ti, m = nt._$Pi, T = nt._$B, P = 0; P < h; P += 3) {
                        ...
                        var S = i[P], v = i[P + 1], L = i[P + 2], M = p + c * e[2 * S], E = f + d * e[2 * S + 1],
                            A = p + c * e[2 * v], I = f + d * e[2 * v + 1], x = p + c * e[2 * L],
                            w = f + d * e[2 * L + 1];
                ...
                var l = s - o, $ = _ - n, u = a - o, p = h - n, f = l * p - $ * u > 0 ? e : -e, c = -$, d = l,
                    ...
                    I = _ - f * d / r, x = s - f * m / P, w = _ - f * T / P, O = a - f * m / P, D = h - f * T / P,
